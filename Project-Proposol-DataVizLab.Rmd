---
title: "Project-Proposol-DataVizLab"
author: "Mengyuan Li"
date: "`r Sys.Date()`"
output: pdf_document
---
...
scikit-learn[https://en.wikipedia.org/wiki/Scikit-learn] is a free software machine learning library for the Python programming language. It features various classification, regression and clustering algorithms including support-vector machines, random forests, gradient boosting, k-means and DBSCAN, and is designed to interoperate with the Python numerical and scientific libraries NumPy and SciPy. Scikit-learn is a NumFOCUS fiscally sponsored project.
...
## Analysis Targets
Using the city records of health violations as the predictive outcome of this analysis, which can be thought of as "minor", "major", and "severe" violations. 
## Tools
